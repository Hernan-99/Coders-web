...
export default function validacion() {
  ...
  ipt.forEach((input) => {
    ...
    span.id = input.name; //asignamos como id el valor que viene en nuestro input
  ...
  d.addEventListener("keyup", (e) => {
    if (e.target.matches(".contact-form [required]")) {
      ...
      //si es un input valida pattern, si es textarea valida data-pattern (data atribute que creamos)
